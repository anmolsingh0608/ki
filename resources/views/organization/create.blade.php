...
<div class="ki-dashboard ki-box-admin">
    <div class="container-xxl px-xxl-0">
        <div class="row">
            <div class="col-md-8">
                <h2 class="m-0 mb-0 title">Add New Organization</h2>
                ...
                @endif
                <form method="POST" class="form-ki" action="{{ route('organizations.store') }}">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-5">
                            <select id="parent_id" class="form-select @error('parent_id') is-invalid @enderror" name="parent_id" value="{{ old('parent_id') }}" autofocus>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-5">
                            <input id="org_id" type="text" class="form-control @error('org_id') is-invalid @enderror" name="org_id" value="{{ old('org_id') }}" required autocomplete="org_id" autofocus>
                    ...
                    <div class="cta-row d-flex mt-5">
                        <button type="submit" class="border-0 py-2 px-4 cta text-uppercase">Add New Org</button>
                    </div>
                </form>
            </div>
        </div>
...
<!-- <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><strong>{{ __('Add New Organization') }}</strong></div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('organizations.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="parent_id" class="form-control @error('parent_id') is-invalid @enderror" name="parent_id" value="{{ old('parent_id') }}" autofocus>
                                    <option value="0">None</option>
                                    @foreach ($org_list as $k => $v)
                                    <option value="{{ $k }}">{{ $v }}</option>
                                    @endforeach
